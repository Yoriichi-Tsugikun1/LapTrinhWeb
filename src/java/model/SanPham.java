...
public class SanPham {
    ...
    public SanPham(String id, String tensp, String manhinh, String cpu, String ram, String ocung,
            String dohoa, String hdh, String trongluong, String kichthuoc,
            String xuatxu, int nam, Double giaban, int soluong, String loai,
            String hang, String img1, String img2, String img3) {
        this.id = id;
        this.tensp = tensp;
