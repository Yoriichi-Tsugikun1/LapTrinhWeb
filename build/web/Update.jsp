        ...
        <form action="UpdateServlet" method="post" enctype="multipart/form-data">
            <div class="tsp">
                <div class="tsp-left">
                    ...
                    <input type="text" name="id" value="${requestScope.sp.id}" readonly>
                    <label for="tensp">Tên Sản Phẩm</label>
                    <input type="text" name="tensp" value="${requestScope.sp.tensp}" required>
                    <label for="giaban">Giá bán</label>
                    <input type="text" name="giaban" value='<fmt:formatNumber pattern="#,###,###" value="${requestScope.sp.giaban}" />' required>
                    <label for="id">Số lượng</label>
                    <input type="number" name="soluong" value="${requestScope.sp.soluong}" required /> 
                    <label for="theloai">Thể loại</label>
                    <input type="text" name="theloai" value="${requestScope.sp.loai}" required>
                    <label for="hang">Hãng : ${requestScope.sp.hang}</label> <br>
                    <select name="hang">
                    ...
                    <div id="imagePreview">
                        <img src="image/${requestScope.sp.img1}" width="50px" alt="alt"/>
                    </div>
                    <label for="mt1">Ảnh 2</label>
                    <input type="file" name="file1" id="fileInput2" accept="image/*">
                    <div id="imagePreview2">
                        <img src="image/${requestScope.sp.img2}" width="50px" alt="alt"/>
                    </div>
                    <label for="mt1">Ảnh 3</label>
                    <input type="file" name="file2" id="fileInput3" accept="image/*">
                    <div id="imagePreview3">
                        <img src="image/${requestScope.sp.img3}" width="50px" alt="alt"/>
                    </div>
                    <script>
                ...
                <div class="tsp-right">
                    ...
                    <table>
                        <tr>
                            <td>Màn hình</td>
                            <td><input type="text" name="mh" value="${requestScope.sp.manhinh}" required></td>
                        </tr>
                        <tr>
                            <td>CPU</td>
                            <td><input type="text" name="cpu" value="${requestScope.sp.cpu}" required></td>
                        </tr>
                        <tr>
                            <td>RAM</td>
                            <td><input type="text" name="ram" value="${requestScope.sp.ram}" required></td>
                        </tr>
                        <tr>
                            <td>Ổ cứng</td>
                            <td><input type="text" name="ocung" value="${requestScope.sp.ocung}" required></td>
                        </tr>
                        <tr>
                            <td>Đồ họa</td>
                            <td><input type="text" name="dohoa" value="${requestScope.sp.dohoa}" required></td>
                        </tr>
                        <tr>
                            <td>Hệ điều hành</td>
                            <td><input type="text" name="hdh" value="${requestScope.sp.hdh}" required></td>
                        </tr>
                        <tr>
                            <td>Trọng lượng</td>
                            <td><input type="text" name="trongluong" value="${requestScope.sp.trongluong}" required></td>
                        </tr>
                        <tr>
                            <td>Kích thước</td>
                            <td><input type="text" name="kichthuoc" value="${requestScope.sp.kichthuoc}" required></td>
                        </tr>
                        <tr>
                            <td>Xuất xứ</td>
                            <td><input type="text" name="xuatsu" value="${requestScope.sp.xuatxu}" required></td>
                        </tr>
                        <tr>
                            <td>Năm ra mắt</td>
                            <td><input type="text" name="namramat" value="${requestScope.sp.nam}" required></td>
                        </tr>
