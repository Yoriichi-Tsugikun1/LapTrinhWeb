...
<html>
    ...
    <body class="background-color">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="inner-main">
                                ...
                                <div class="fxoa">
                                    <form action="HuyServlet" method="GET">
                                        <input type="hidden" name="huy" value="${i.id}" />
                                        <button type="submit">
                                            <i class="fa fa-trash"></i> Hủy
                                        </button>
                                    </form>

                                    <form action="ChapNhanServlet" method="GET" class="ri">
                                        <input type="hidden" name="chapnhan" value="${i.id}" />
                                        <button type="submit">
        ...
        <c:if test="${not empty requestScope.er}">
            <script>
                                        alert("${requestScope.er}");
            </script>
        </c:if>
    </body>
</html>
