...
<html>
  ...
  table tbody tr:last-child {
    border-bottom: 3px solid #2b80dd;
  }
  ...
  table tbody tr:hover {
    ...
    <body class="background-color">
        ...
        <div class="tbao" style="background-color: rgb(242,242,254)">
            ...
            <p style="text-align: center; background-color: rgb(242,242,254); font-size: 25px">Bảng thông tin tài khoản</p>
        </div>

        <div class="dstk" style="background-color: rgb(242,242,254)">
            <table>
                <tr>
                    <th>Account</th>
                    <th>Password</th>
                ...
                <c:forEach items="${requestScope.data}" var="i" >
                    <tr>
                        <td>${i.account}</td>
                        <td>****</td>
                        <td><a href="ResetServlet?account=${i.account}">ResetPassword</a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
    ...
    <c:if test="${not empty sessionScope.tbrs}">
        <script>
                                        alert("${sessionScope.tbrs}");
            <% session.setAttribute("tbrs", null); %>
        </script>
    </c:if>
</html>
