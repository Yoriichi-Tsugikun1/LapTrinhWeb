...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .section-1 .inner-wrap .btn-cart:hover{
                    ...
                    <div class="inner-wrap">
                        <div class="col-4">
                            <div class="inner-image">
                                <img id="myImg" src="image/${i.img1}" alt="">
                            </div>
...
<script type="text/javascript">
                                    function change1() {
                                        document.getElementById('myImg').src = "image/${requestScope.data.img1}";
                                    }
                                    function change2() {
                                        document.getElementById('myImg').src = "image/${requestScope.data.img2}";
                                    }
                                    function change3() {
                                        document.getElementById('myImg').src = "image/${requestScope.data.img3}";
                                    }
                                    function buy(id) {
