...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .section-5 .inner-item img{
                padding: 10px;
                transition: all 0.4s ease-in-out;
            }

            .section-5 .inner-name p{
                font-size: 18px;
            }
            .section-5 .inner-price h5{
                color: var(--color-3);
                font-style: italic;
            }
            .dropbtn {
            ...
            button .fa-times {
                ...
                border: 2px solid #000; /* Tạo viền cho biểu tượng */
                border-radius: 50%; /* Làm tròn viền */
                padding: 5px; /* Tạo khoảng cách giữa biểu tượng và viền */
            }
            .container-img {
                position: relative;
            }
        ...
        <script type="text/javascript">
            function doDelete(id) {
                if (confirm("Nếu muốn xóa ! Hãy chắc chắn mã sản phẩm không tồn tại trong các bản ghi khác")) {
                        ...
                        <div class="col-3">
                            <div class="inner-item">
                                <c:if test="${sessionScope.account.role==2}">
                                    <a href="###" onclick="doDelete('${i.id}')" ><i class="fa fa-times"></i></a>
                                    </c:if>
                                <div class="inner-image">
                                    <div href="chitietsanpham?id=${i.id}" class="container-img">
                                        <img src="image/${i.img1}" class="image" >
                                        <div class="middle">
                                            <a href="chitietsanpham?id=${i.id}" class="text"><i class="fa-solid fa-eye"></i></a>
                                        </div>
                                    </div>
<!--                                    <a href="chitietsanpham?id=${i.id}"><img src="image/${i.img1}" ></a>-->
                                    ...
                                    <c:if test="${sessionScope.account.role==2}">
                                        <form action="UpdateServlet">
                                            <input type="hidden" name="id" value="${i.id}" >
                                            <button type="submit" class="add-btn">Cập nhật<i class='fas fa-sync-alt'></i></button>
                                        </form>
                                    </c:if>
        ...
        <div class="section-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="inner-image">
                            <img src="image/laptop-background-vanphong-pc-24082022.jpg">
                        </div>
                    </div>   
                </div>
                <div class="row">
                    <jsp:useBean id="db" class="dal.SanPhamDAO" />
                    <c:forEach items="${db.lapTopVanPhong}" var="i">
                        <div class="col-3">
                            <div class="inner-item">
                                <c:if test="${sessionScope.account.role==2}">
                                    <a href="###" onclick="doDelete('${i.id}')" ><i class="fa fa-times"></i></a>
        ...
        <div class="section-5">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="inner-image">
                            <img src="image/laptop-background-gaming-pc-24082022.jpg">
                        </div>
                    </div>   
                </div>
                <div class="row">
                    <jsp:useBean id="db1" class="dal.SanPhamDAO" />
                    <c:forEach items="${db1.lapTopGamming}" var="i" >
                        <div class="col-3">
                            <div class="inner-item">
                                <c:if test="${sessionScope.account.role==2}">
                                    <a href="###" onclick="doDelete('${i.id}')" ><i class="fa fa-times"></i></a>
    ...
    <c:if test="${not empty sessionScope.tbx}">
        <script>
                                        alert("${sessionScope.tbx}");
            <% session.setAttribute("tbx", null); %>
        </script>
    </c:if>
        <c:if test="${not empty sessionScope.tbm}">
            <script>
            alert("${sessionScope.tbm}");
                <% session.setAttribute("tbm", null); %>
            </script>
        </c:if>
</body>
</html>
